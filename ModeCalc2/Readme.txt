'../Mcalc' source files in ./ModeCalc2/

"ModeCalc2" focuses on calculating effective index with high precision difference.
Generated data cannot be used for "Scalc", "FDTD".

The following is previous Readme for ModeCalc.
